...
labelFile = './data/C1.0_24hr_224_png_Labels.txt' # label file
...
testARList = './data/List_of_AR_in_Test_Data_by_AR.csv' #list of active regions in TestData
valARList  = './data/List_of_AR_in_Validation_data_by_AR.csv' #list of active regions in ValData
# Modify the following to reflect the desired location of the dataframe files output by this code
testdata_file = './data/cnn_features/Test_Data_by_AR_png_224.csv'
valdata_file = './data/cnn_features/Validation_Data_by_AR_png_224.csv'
traindata_file = './data/cnn_features/Train_Data_by_AR_png_224.csv'
