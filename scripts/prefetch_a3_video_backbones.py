...
def main() -> None:
    ...
    if not (args.r3d18 or args.r2plus1d18 or args.slowfast or args.videoswin or args.timesformer):
        raise SystemExit("Pick at least one: --r3d18, --r2plus1d18, --slowfast, --videoswin, --timesformer")
